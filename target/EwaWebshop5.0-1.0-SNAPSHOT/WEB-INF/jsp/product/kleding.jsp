            ...
            <div class="modal-dialog modal-sm">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="ORDEROVERZICHT" method="post">
                    ...
                    <div class="row products">
                        ...
                        <div class="col-md-3 col-sm-4">
                            <div class="product">
                                ...
                                <!-- /.image -->
                                <div class="text">
                                    <h3><a href="productPagina">Werkkleding</a></h3>
                                </div>
                                <!-- /.text -->
                            ...
                            <div class="product">
                                ...
                                <!-- /.image -->
                                <div class="text">
                                    <h3><a href="productPagina">Schoeisel</a></h3>
                                </div>
                                <!-- /.text -->
                            ...
                            <div class="product">
                                ...
                                <!-- /.image -->
                                <div class="text">
                                    <h3><a href="productPagina">Veiligheid</a></h3>
                                </div>
                                <!-- /.text -->
