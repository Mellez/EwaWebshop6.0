<%-- 
    Document   : bevestigingsmaterialen
    Created on : 28-okt-2014, 15:15:11
    Author     : Bas
--%>
<%-- 
    Document   : testindex
    Created on : 30-okt-2014, 12:28:11
    Author     : Bas
--%>
                    ...
                    <div class="row products">
                        ...
                        <div class="col-md-3 col-sm-4">
                            <div class="product">
                                ...
                                <!-- /.image -->
                                <div class="text">
                                    <h3><a href="productPagina">Nagels / Nieten</a></h3>
                                </div>
                                <!-- /.text -->
                        ...
                        <div class="col-md-3 col-sm-4">
                            <div class="product">
                                ...
                                <!-- /.image -->
                                <div class="text">
                                    <h3><a href="productPagina">Pluggen</a></h3>
                                </div>
                                <!-- /.text -->
                        ...
                        <div class="col-md-3 col-sm-4">
                            <div class="product">
                                <div class="image">
                                    <a href="productPagina">
                                        <img src="../resources/imgSite/schroef.jpg" alt="" class="img-responsive image1">
                                    </a>
                                </div>
                                <!-- /.image -->
                                <div class="text">
                                    <h3><a href="productPagina">Schroeven</a></h3>
                                </div>
                                <!-- /.text -->
                        ...
                        <div class="col-md-3 col-sm-4">
                            <div class="product">
                                ...
                                <!-- /.image -->
                                <div class="text">
                                    <h3><a href="productPagina">Verbindingen</a></h3>
                                </div>
                                <!-- /.text -->
                        ...
                        <div class="col-md-3 col-sm-4">
                            <div class="product">
                                <div class="image">
                                    <a href="productPagina">
                                        <img src="../resources/imgSite/Uitvulplaatje.jpg" alt="" class="img-responsive image1">
                                    </a>
                                </div>
                                <!-- /.image -->
                                <div class="text">
                                    <h3><a href="productPagina">Uitvulplaatjes / wiggen</a></h3>
                                </div>
                                <!-- /.text -->
                        ...
                        <div class="col-md-3 col-sm-4">
                            <div class="product">
                                <div class="image">
                                    <a href="productPagina">
                                        <img src="../resources/imgSite/boutenmoer.jpg" alt="" class="img-responsive image1">
                                    </a>
                                </div>
                                <!-- /.image -->
                                <div class="text">
                                    <h3><a href="productPagina">Bouten / Moeren</a></h3>
                                </div>
                                <!-- /.text -->
                        ...
                        <div class="col-md-3 col-sm-4">
                            <div class="product">
                                <div class="image">
                                    <a href="productPagina">
                                        <img src="../resources/imgSite/kit.jpg" alt="" class="img-responsive image1">
                                    </a>
                                </div>
                                <!-- /.image -->
                                <div class="text">
                                    <h3><a href="productPagina">Lijmen / Kitten / Pur</a></h3>
                                </div>
                                <!-- /.text -->
                        ...
                        <div class="col-md-3 col-sm-4">
                            <div class="product">
                                <div class="image">
                                    <a href="productPagina">
                                        <img src="../resources/imgSite/tape.jpg" alt="" class="img-responsive image1">
                                    </a>
                                </div>
                                <!-- /.image -->
                                <div class="text">
                                    <h3><a href="productPagina">Tapes</a></h3>
                                </div>
                                <!-- /.text -->
                        ...
                        <div class="col-md-3 col-sm-4">
                            <div class="product">
                                <div class="image">
                                    <a href="productPagina">
                                        <img src="../resources/imgSite/garderobe.jpg" alt="" class="img-responsive image1">
                                    </a>
                                </div>
                                <!-- /.image -->
                                <div class="text">
                                    <h3><a href="bevestigingsmaterialen">Garderobesystemen</a></h3>
                                </div>
                                <!-- /.text -->
                        ...
                        <div class="col-md-3 col-sm-4">
                            <div class="product">
                                ...
                                <!-- /.image -->
                                <div class="text">
                                    <h3><a href="productPagina">Overige bevestigingen</a></h3>
                                </div>
                                <!-- /.text -->
