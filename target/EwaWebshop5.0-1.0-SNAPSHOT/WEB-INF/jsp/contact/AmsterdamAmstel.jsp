    ...
    <head>
        ...
        <script>
            function initialize() {
                var mapOptions = {
                    zoom: 15,
                    center: new google.maps.LatLng(52.336091, 4.933908),
                ...
                var myLatLng = new google.maps.LatLng(52.336091, 4.933908);
                        ...
                        <div class="box text-center">
                            ...
                            <div class="row">
                                <div class="col-sm-10 col-sm-offset-1">
                                    <h1>Contact - Amsterdam Amstel</h1>
                        ...
                        <div class="box" id="contact">
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <p><strong>T:</strong> 020 - 560 76 66
                                        <br><strong>F:</strong> 020 - 560 76 99
                                        <br>
                                        <strong>E: <a href="mailto:">stihoamsterdamamstel@stiho.nl</a></strong>
                                    </p>
                                </div>
                                <!-- /.col-sm-4 -->
                                <div class="col-sm-4">
