            ...
            <div class="container">
                ...
                <div class="col-md-12">
                    <ul class="breadcrumb">
                        ...
                        <li><a href="${pageContext.request.contextPath}/customer/Account">Home</a>
                        </li>
                        <li>Mijn orders</li>
                    </ul>
                    ...
                    <div class="box text-center">
                        ...
                        <div class="row">
                            <div class="col-sm-10 col-sm-offset-1">
                                ...
                                <p class="lead">Jouw orders op één plaats</p>
                                <p class="text-muted">heeft u vragen? Neem dan gerust <a href="${pageContext.request.contextPath}/contact/AmsterdamAmstel">contact</a> met ons opnemen.</p>
                            </div>
                        </div>
                    </div>
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>11/11/2014</td>
                                        <td>$ 150.00</td>
                                        <td><span class="label label-info">Wordt voorbereid</span>
                                        </td>
                                        <td><a href="customer-order.html" class="btn btn-primary btn-sm">Bekijk</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th># 1735</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>11/11/2014</td>
                                        <td>$ 150.00</td>
                                        <td><span class="label label-success">Ontvangen</span>
                                        </td>
                                        <td><a href="customer-order.html" class="btn btn-primary btn-sm">Bekijk</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>11/11/2014</td>
                                        <td>$ 150.00</td>
                                        <td><span class="label label-danger">Geanuleerd</span>
                                        </td>
                                        <td><a href="customer-order.html" class="btn btn-primary btn-sm">Bekijk</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>11/11/2014</td>
                                        <td>$ 150.00</td>
                                        <td><span class="label label-warning">Wacht</span>
                                        </td>
                                        <td><a href="customer-order.html" class="btn btn-primary btn-sm">Bekijk</a>
                                        </td>
                                    </tr>
