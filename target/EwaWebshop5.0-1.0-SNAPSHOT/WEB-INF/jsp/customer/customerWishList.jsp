                    ...
                    <div class="box text-center">
                        ...
                        <div class="row">
                            <div class="col-sm-10 col-sm-offset-1">
                                ...
                                <p class="lead">Producten die u al vaker heeft bekeken.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row products">
                        ...
                        <div class="col-md-3 col-sm-4">
                            <div class="product">
                                ...
                                <!-- /.image -->
                                <div class="text">
                                    <h3><a href="detail.html">Schroef</a></h3>
                        ...
                        <div class="col-md-3 col-sm-4">
                            <div class="product">
                                <div class="image">
                                    <a href="detail.html">
                                        <img src="../resources/imgSite/pluggen.jpg" alt="" class="img-responsive image1">
                                    </a>
                                </div>
                                <!-- /.image -->
                                <div class="text">
