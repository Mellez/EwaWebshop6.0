<%-- 
    ...
    Created on : 9-nov-2014, 17:25:59
    Author     : Bas
--%>
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li>
                                <div class="yamm-content">
                                    <div class="row">
                                        <div class="col-sm-3">
                                            <img src="${pageContext.request.contextPath}/resources/img/schroef1.jpg" class="img-responsive hidden-xs" alt="">
                                        </div>
                                        <div class="col-sm-3">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li>
                                <div class="yamm-content">
                                    <div class="row">
                                        <div class="col-sm-3">
                                            <img src="${pageContext.request.contextPath}/resources/imgSite/Accessoires.jpg" class="img-responsive hidden-xs" alt="">
                                        </div>
                                        <div class="col-sm-3">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li>
                                <div class="yamm-content">
                                    <div class="row">
                                        <div class="col-sm-3">
                                            <img src="${pageContext.request.contextPath}/resources/imgSite/Deurbeslag.png" class="img-responsive hidden-xs" alt="">
                                        </div>
                                        <div class="col-sm-3">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li>
                                <div class="yamm-content">
                                    <div class="row">
                                        <div class="col-sm-3">
                                            <img src="${pageContext.request.contextPath}/resources/img/contact.jpg" class="img-responsive hidden-xs" alt="">
                                        </div>
                                        <div class="col-sm-3">
                                            <h3>Contact</h3>
                                            <ul>
            ...
            <div class="container">
                ...
                <div class="col-md-6">
                    <div class="box">
                        ...
                        <p class="lead">Nog niet geregistreerd?</p>
                        <p>Maakt vaker bestellen bij ons een stuk makkelijker!</p>
                ...
                <div class="col-md-6">
                    <div class="box">
                        ...
                        <p class="lead">Al een geregistreerde klant?</p>
                        <p class="text-muted">Log hier dan in!</p>
